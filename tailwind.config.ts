...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'neon-primary':  '0 0 20px hsl(var(--primary)/0.5),   0 0 60px hsl(var(--primary)/0.2)',
        'neon-secondary':'0 0 20px hsl(var(--secondary)/0.5), 0 0 60px hsl(var(--secondary)/0.2)',
        'neon-accent':   '0 0 20px hsl(var(--accent)/0.5),    0 0 60px hsl(var(--accent)/0.2)',
      ...
      keyframes: {
        ...
        'scan-line':  { '0%': { top: '0%', opacity: '1' }, '95%': { top: '100%', opacity: '1' }, '100%': { top: '100%', opacity: '0' } },
      },
      animation: {
