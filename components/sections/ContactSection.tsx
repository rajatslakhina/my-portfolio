      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            ...
            <motion.div
              className="relative border border-primary/20 bg-card/50 backdrop-blur-xl overflow-hidden"
            ...
            >
              ...
              <p className="px-5 py-4 font-mono-accent text-[11px] leading-relaxed text-muted-foreground">
                <span className="text-primary">{">"}</span>{" "}
                Open to new opportunities, collaborations, and conversations about mobile technology. Response time: &lt; 24h
              </p>
            </motion.div>
            ...
            <motion.a
              ...
              className="mt-2 flex w-full items-center justify-center gap-3 border-2 py-4 font-mono-accent text-sm font-bold uppercase tracking-widest transition-all duration-300 relative overflow-hidden group"
              style={{
            ...
            >
              ...
              <span className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 z-10" style={{ borderColor: "hsl(142 72% 50%)" }} />
              <span className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 z-10" style={{ borderColor: "hsl(142 72% 50%)" }} />
              <WhatsAppIcon className="relative h-5 w-5" />
              <span className="relative">Chat on WhatsApp</span>
              <span className="relative font-mono-accent text-[10px] opacity-60">&middot; instant connect</span>
            </motion.a>
          </div>
          ...
          >
            ...
            {/* Form panel */}
            <div
              className="flex-1 border border-primary/15 bg-card/40 backdrop-blur-xl p-6 sm:p-8"
              style={{ clipPath: "polygon(0 0,calc(100% - 14px) 0,100% 14px,100% 100%,14px 100%,0 calc(100% - 14px))" }}
            >
              <span className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-primary/40" />
              <span className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-primary/20" />
                ...
                <div className="flex h-full items-center justify-center">
                  <div className="flex flex-col items-center gap-4 text-center py-12">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">Thanks &mdash; I&apos;ll get back to you within 48 hours.</p>
                    </div>
                  </div>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        className={cn(
                          "border bg-background/60 px-3 py-2.5 font-mono-accent text-[11px] text-foreground",
                          "placeholder:text-muted-foreground/40 focus:outline-none transition-colors",
                          "border-white/10 focus:border-primary/50 dark:border-white/10",
                        )}
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className={cn(
                        "resize-none border bg-background/60 px-3 py-2.5 font-mono-accent text-[11px] text-foreground",
                        "placeholder:text-muted-foreground/40 focus:outline-none transition-colors",
                        "border-white/10 focus:border-primary/50 dark:border-white/10",
                      )}
                      style={{ clipPath: "polygon(0 0,calc(100% - 6px) 0,100% 6px,100% 100%,6px 100%,0 calc(100% - 6px))" }}
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 border border-primary/40 bg-primary/10 px-6 py-3.5 font-mono-accent text-[10px] uppercase tracking-widest text-primary hover:border-primary/70 hover:bg-primary/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                    style={{ clipPath: "polygon(0 0,calc(100% - 8px) 0,100% 8px,100% 100%,8px 100%,0 calc(100% - 8px))" }}
                  >
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-w-0 flex-1">
        ...
        <p className="text-sm font-medium text-foreground transition-colors duration-200 truncate">{item.value}</p>
      </div>
